...
public class WindowManagerService extends IWindowManager.Stub implements Watchdog.Monitor {
    ...
    final TokenWatcher mKeyguardDisabled = new TokenWatcher(
        ...
        public void acquired() {
            Log.d(TAG, "aquired keyguard");
            mPolicy.enableKeyguard(false);
        }
        public void released() {
            synchronized (mKeyguardDisabled) {
            Log.d(TAG, "released keyguard");
    ...
    // -------------------------------------------------------------
    //
    // (Stericson) Where you see, getCallingUid() != 1000, this is used
    // to allow Services.jar access to the api for disabling and reenabling 
    // the Keyguard. This is needed for the StatusBar to disable the Keyguard.
    // This was deemed safe to me by JF. {Disabled for now}
