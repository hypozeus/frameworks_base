...
public class StatusBarService extends IStatusBar.Stub
{
    ...
    //(Stericson) This controls enabling and disabling the keyguard when the 
    // status bar notification has been chosen while the lockscreen is up.
    // This watches for the screen to go off and reenables the keyguard at that point. {Disabled for now}
    //
    //    BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
    //         public void onReceive(Context context, Intent intent) {
    //             if (intent.getAction().equals(Intent.ACTION_SCREEN_OFF))  {
    //                Log.d(TAG, "Screen turned off, caught");
    //                reenableKeyguard();
    //                }
    //       }
    //   };
    ...
    //    private KeyguardLock myKL = null;
    //
    ...
    //                    myKL = myKM.newKeyguardLock("Statbarunlock");
    ...
    //    }
    //
    // End of change, Thanks for visiting! (Stericson) {Disabled for now}
    // Come back soon.....
